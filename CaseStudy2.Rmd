...
Marital Status       | **Married** employees are **more** likely to leave.  This observation may be tied to other factors and can be challenging for company to address
Distrance From Home  | **Farther** employees are locations, employees are **more** likely to leave
...
-------------------- | --------------------------------------------------------------------------------------------------
Overtime             | **Higher** reported Overtime, employees are **more** likely to leave
Total Working Years  | **Higher** working years on employees are **more** likely to leave
Job Level            | **Higher** job levels, employees are **more** likely to leave
